...
//         el('custo_total_obra').textContent =
//             `Total ${formatarMoeda(custoObra)}`;

//         /* ---------- DESPESAS ---------- */
//         const condominio = 0;
//         const custoDinheiro = 0;
//         const agua = AGUA_ENERGIA_FIXO;
...
//         el('to_agua_luz').textContent = `Água e Luz (fixo): ${formatarMoeda(agua)}`;
